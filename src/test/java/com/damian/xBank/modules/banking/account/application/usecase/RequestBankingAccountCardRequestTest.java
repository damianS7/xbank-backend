...
public class RequestBankingAccountCardRequestTest extends AbstractServiceTest {
    ...
    @InjectMocks
    private RequestBankingAccountCard requestBankingAccountCard;
    ...
    void cardRequest_WhenValidRequest_ReturnsBankingCard() {
        ...
        RequestBankingAccountCardCommand command = new RequestBankingAccountCardCommand(
        ...
        BankingCard result = requestBankingAccountCard.execute(command);
    ...
    void cardRequest_WhenAccountNotFound_ThrowsException() {
        ...
        BankingAccountNotFoundException exception = assertThrows(
            ...
            () -> requestBankingAccountCard.execute(command)
        );

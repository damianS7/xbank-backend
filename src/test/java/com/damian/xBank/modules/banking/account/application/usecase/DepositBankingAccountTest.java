...
public class DepositBankingAccountTest extends AbstractServiceTest {

    @InjectMocks
    private DepositBankingAccount depositBankingAccount;
    ...
    void deposit_WhenValidRequest_ReturnsTransaction() {
        ...
        // then
        BankingTransaction result = depositBankingAccount.execute(command);
    ...
    void deposit_WhenNotAdmin_ThrowsException() {
        ...
        BankingAccountDepositNotAdminException exception = assertThrows(
            ...
            () -> depositBankingAccount.execute(command)
        );

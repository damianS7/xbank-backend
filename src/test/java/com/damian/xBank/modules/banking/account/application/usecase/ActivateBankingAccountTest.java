...
import com.damian.xBank.modules.banking.account.application.cqrs.command.ActivateBankingAccountCommand;
...
public class ActivateBankingAccountTest extends AbstractServiceTest {

    @Mock
    private BankingAccountRepository bankingAccountRepository;

    @InjectMocks
    private ActivateBankingAccount activateBankingAccount;
    ...
    void execute_WhenSuspendedAccountActiveByAdmin_ReturnActiveAccount() {
        ...
        ActivateBankingAccountCommand command = new ActivateBankingAccountCommand(
        ...
        BankingAccount result = activateBankingAccount.execute(command);
    ...
    void execute_WhenClosedAccount_ThrowsException() {
        ...
        BankingAccountStatusTransitionException exception = assertThrows(
            ...
            () -> activateBankingAccount.execute(command)
        );

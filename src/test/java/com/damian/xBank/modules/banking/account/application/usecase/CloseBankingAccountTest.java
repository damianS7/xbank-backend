...
public class CloseBankingAccountTest extends AbstractServiceTest {

    @Mock
    private BankingAccountRepository bankingAccountRepository;

    @InjectMocks
    private CloseBankingAccount closeBankingAccount;
    ...
    void closeAccount_WhenValidRequest_ReturnsClosedBankingAccount() {
        ...
        closeBankingAccount.execute(command);
    ...
    void closeAccount_WhenAccountNotOwnedByCustomerButItIsAdmin_ThrowsException() {
        ...
        BankingAccountResult result = closeBankingAccount.execute(command);

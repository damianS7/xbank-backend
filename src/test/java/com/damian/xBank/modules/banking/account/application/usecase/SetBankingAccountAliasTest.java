...
public class SetBankingAccountAliasTest extends AbstractServiceTest {

    @Mock
    private BankingAccountRepository bankingAccountRepository;

    @InjectMocks
    private SetBankingAccountAlias setBankingAccountAlias;
    ...
    void setAlias_WhenValidRequest_ReturnsAccountWithUpdatedAlias() {
        ...
        SetBankingAccountAliasCommand command = new SetBankingAccountAliasCommand(
        ...
        setBankingAccountAlias.execute(command);

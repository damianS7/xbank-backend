...
public class UnlockBankingCardTest extends AbstractServiceTest {

    @Mock
    private BankingCardRepository bankingCardRepository;

    @InjectMocks
    private UnlockBankingCard unlockBankingCard;
    ...
    void unlockCard_WhenValid_ReturnsUnlockedCard() {
        ...
        UnlockBankingCardCommand command = new UnlockBankingCardCommand(
            bankingCard.getId(),
            RAW_PASSWORD
        );
        ...
        unlockBankingCard.execute(command);

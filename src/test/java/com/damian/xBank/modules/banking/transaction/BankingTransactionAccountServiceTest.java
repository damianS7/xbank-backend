...
//        customerA = new Customer(99L, "customerA@test.com", passwordEncoder.encode(RAW_PASSWORD));
//        customerB = new Customer(92L, "customerB@test.com", passwordEncoder.encode(RAW_PASSWORD));
//        customerAdmin = new Customer(95L, "admin@test.com", passwordEncoder.encode(RAW_PASSWORD));
//        customerAdmin.getAccount().setRole(UserAccountRole.ADMIN);
//    }
//
//    @Test

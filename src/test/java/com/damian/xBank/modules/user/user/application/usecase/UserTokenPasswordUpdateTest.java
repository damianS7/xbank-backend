...
public class UserTokenPasswordUpdateTest extends AbstractServiceTest {
    ...
    @InjectMocks
    private UserTokenPasswordUpdate userTokenPasswordUpdate;
    ...
    void shouldSetPasswordAfterGeneratePasswordResetToken() {
        ...
        UserPasswordResetSetRequest passwordResetRequest = new UserPasswordResetSetRequest(
                rawNewPassword
        );
        ...
        userTokenPasswordUpdate.execute(token.getToken(), passwordResetRequest);

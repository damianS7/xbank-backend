...
import com.damian.xBank.modules.banking.transaction.application.cqrs.query.GetAccountTransactionsQuery;
import com.damian.xBank.modules.banking.transaction.application.cqrs.query.GetCardTransactionsQuery;
import com.damian.xBank.modules.banking.transaction.application.cqrs.query.GetPendingTransactionsQuery;
...
import com.damian.xBank.modules.banking.transaction.application.cqrs.result.GetAccountTransactionsResult;
import com.damian.xBank.modules.banking.transaction.application.cqrs.result.GetCardTransactionsResult;
import com.damian.xBank.modules.banking.transaction.application.cqrs.result.GetPendingTransactionsResult;
import com.damian.xBank.modules.banking.transaction.application.usecase.GetAccountTransactions;
import com.damian.xBank.modules.banking.transaction.application.usecase.GetCardTransactions;
import com.damian.xBank.modules.banking.transaction.application.usecase.GetPendingTransactions;
import com.damian.xBank.modules.banking.transaction.application.usecase.GetTransaction;

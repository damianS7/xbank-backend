...
import com.damian.xBank.modules.banking.transfer.application.usecase.transfer.outgoing.create.CreateOutgoingTransfer;
...
import com.damian.xBank.modules.banking.transfer.application.usecase.transfer.outgoing.get.GetOutgoingTransfers;
import com.damian.xBank.modules.banking.transfer.application.usecase.transfer.outgoing.get.GetOutgoingTransfersQuery;
import com.damian.xBank.modules.banking.transfer.application.usecase.transfer.outgoing.get.GetOutgoingTransfersResult;
...
public class BankingTransferController {
    ...
    public ResponseEntity<?> transfer(
        ...
        CreateOutgoingTransferCommand command = BankingTransferDtoMapper.toCreateTransferCommand(request);
    ...
    public ResponseEntity<?> confirm(
        ...
        ConfirmOutgoingTransferCommand command = BankingTransferDtoMapper.
    ...
    public ResponseEntity<?> reject(
        ...
        RejectOutgoingTransferCommand command = BankingTransferDtoMapper.toRejectTransferCommand(id, request);

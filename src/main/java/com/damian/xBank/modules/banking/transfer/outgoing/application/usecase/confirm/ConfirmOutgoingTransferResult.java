...
public record ConfirmOutgoingTransferResult(
    Long id,
    Long fromAccountId,
    ...
    public static ConfirmOutgoingTransferResult from(OutgoingTransfer transfer) {
        return new ConfirmOutgoingTransferResult(
            transfer.getId(),

package com.damian.xBank.modules.banking.account.application.usecase.account.create;
...
public record CreateAccountResult(
    ...
    public static CreateAccountResult from(BankingAccount bankingAccount) {

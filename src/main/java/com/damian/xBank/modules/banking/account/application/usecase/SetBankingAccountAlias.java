...
@Service
public class SetBankingAccountAlias {
    private final BankingAccountRepository bankingAccountRepository;
    private final AuthenticationContext authenticationContext;

    public SetBankingAccountAlias(
     ...
     */
    public BankingAccountResult execute(SetBankingAccountAliasCommand command) {
        // Customer logged
        ...
        return BankingAccountResult.from(bankingAccount);
    }
}
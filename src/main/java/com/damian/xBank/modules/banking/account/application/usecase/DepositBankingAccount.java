...
@Service
public class DepositBankingAccount {
    private static final Logger log = LoggerFactory.getLogger(DepositBankingAccount.class);
     ...
     */
    @Transactional
    public BankingTransaction execute(DepositBankingAccountCommand command) {
        // Current user

-- Users
INSERT INTO public.users (email, password_hash, "role", account_status, created_at, updated_at) values
	 ('damian@demo.com', '$2a$10$hyxP/Azy1W1OjjhRarmDzO3J.CcMc5n1D4UzQJKUD4YD/yPV4AL06','ADMIN'::public."user_role_type", 'PENDING_VERIFICATION'::public."user_account_status_type",'2025-04-17 02:07:41.382291','2025-04-17 02:07:41.382291'),
	 ('alice@demo.com', '$2a$10$hyxP/Azy1W1OjjhRarmDzO3J.CcMc5n1D4UzQJKUD4YD/yPV4AL06','USER'::public."user_role_type", 'PENDING_VERIFICATION'::public."user_account_status_type", '2025-04-06 02:42:27.378616','2025-04-06 02:42:27.378616');

-- Customer
INSERT INTO public.customers (user_id,first_name,last_name,phone,birthdate,gender,photo,address,postal_code,country,national_id,updated_at) VALUES
	 (1,'Damian','White','701 444 113','1987-06-02','MALE'::public."customer_gender_type", 'avatar.jpg','Apple AV.','50240','USA','723173823Z','2025-04-28 01:47:10.771533'),
	 (2,'Alice','Brown','901 322 223','1993-07-04','FEMALE'::public."customer_gender_type", 'avatar.jpg','Lemon AV','30140','USA','01116613Z','2025-04-28 01:48:28.903419');
...
-- BankingCards
INSERT INTO public.banking_cards (account_id,card_type,card_status,card_number,notes, card_pin, card_cvv,created_at,updated_at) VALUES
...
-- BankingTransactions
INSERT INTO public.banking_transactions (account_id, card_id, transaction_type, amount, description, status, created_at, updated_at) VALUES
